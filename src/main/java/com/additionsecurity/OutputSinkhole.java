...
class OutputSinkhole implements ICTIOutput {

	private static final String DESC = "Sinkhole";

	private ICTITransform _transform;

	public OutputSinkhole(Properties prop, ICTITransform transform) throws Exception
	{
	...
	{
		// sinkhole: do nothing/throw it away
	}
}
