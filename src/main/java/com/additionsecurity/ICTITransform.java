...
public interface ICTITransform {
	...
	public static class ICTITransformException extends Exception {
		public ICTITransformException() { super(); }
		public ICTITransformException(String message) { super(message); }
		public ICTITransformException(String message, Throwable cause) { super(message, cause); }
	}
}
