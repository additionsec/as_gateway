...
public class TransformCEFTest extends TestCase
{
    public TransformCEFTest( String testName ) {
        super( testName );
    }
    ...
    public static Test suite() {
        return new TestSuite( TransformCEFTest.class );
    }
	...
	public void testBasic() throws Exception {
		_transform = new TransformCEF( _prop );
		...
		assertTrue( "cef".equals(_transform.extension()) );
