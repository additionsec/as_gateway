...
public class TransformKVPTest extends TestCase
{
    public TransformKVPTest( String testName ) {
        super( testName );
    }
    ...
    public static Test suite() {
        return new TestSuite( TransformKVPTest.class );
    }
	...
	public void testBasic() throws Exception {
		_transform = new TransformKVP2( _prop );
		...
		assertTrue( "txt".equals(_transform.extension()) );
