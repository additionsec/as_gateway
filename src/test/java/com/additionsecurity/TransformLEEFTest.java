...
public class TransformLEEFTest extends TestCase
{
    public TransformLEEFTest( String testName ) {
        super( testName );
    }
    ...
    public static Test suite() {
        return new TestSuite( TransformLEEFTest.class );
    }
	...
	public void testBasic() throws Exception {
		_transform = new TransformLEEF( _prop );
		...
		assertTrue( "leef".equals(_transform.extension()) );
